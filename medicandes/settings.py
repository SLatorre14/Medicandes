"""
Django settings for medicandes project.
...
ROOT_URLCONF = 'medicandes.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'medicandes', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'medicandes.wsgi.application'
